...
|Servis Gerektiren Ürün|Bu kutucuk, teknik servis gerektiren ürünler için kullanılmaktadır. **Örnek:** Çamaşır mak., bulaşık mak. gibi ürünlerin satışında kurulum gerçekleştirileceği için bu flag kullanılabilir. Sistem bu tarz ürünler içeren bir faturanın onaylanması sırasında öncelikle servis seçiminin yapılmasını zorunlu yapacaktır.
|Önyüzde Göster|Bu butona tıklandığında görüntülemekte olan ürünün önyüz sayfası açılır||
