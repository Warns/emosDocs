...
|--|--|--|
|Başlık|Kampanyanın isminin girildiği alandır. Promosyon popup'ında ve müşteri sepetinde görülecek  başlık bilgisidir.	|%30 İndirim Kampanyası|
|Promosyon Metni	|Kampanyaya ait her türlü açıklamanın yapıldığı alandır. Kampanyalar anasayfasında ve kampanya seçimi popup'ında müşteriye gösterilir.	|Geçerlilik tarihi, faydalanma şartları gibi|
|Resim	| ***SS*** seçim butonu ile kampanya resminin seçildiği alandır.Eğer seçilecek resim kayıtlı değilse dosya yükleme butonunu kullanarak sisteme yeni bir resim yüklenebilir. Bu resim kampanyalar anasayfasında ve kampanya seçimi popup'ında gösterilir.	||
|Fiyat Tipi	|  ***SS*** butonuna tıklanarak kampanyanın geçerli olduğu fiyat tipinin seçildiği alandır. Boş bırakıldığında bütün fiyat tipleri için geçerli olduğu anlamına gelir.	|Perakende|
...
|Başlangıç Tarihi	|Kampanyanın başladığı tarihin girildiği alandır.|21.07.2012|
...
|Ödeme Tipi	|Kampanyanın sadece belirlenmiş olan ödeme tipinde çalışmasını sağlamak amacı ile ödeme tipi seçilebilir. Bu bilgi girildiğinde kampanya uygulaması ödeme bilgileri aşamasında yapılır.	|Kredi kartı|
|Banka|Kampanyanın sadece belirlenen bankalar ile ödeme yapıldığında çalışmasını sağlamak amacıyla banka seçilebilir. Bu bilgi girildiğinde kampanya uygulaması ödeme bilgileri aşamasında yapılır.	|Garanti Bankası|
|Durum|Yeni,onaylı,kapandı ve iptal seçenekerinden oluşur. Seçim butonuna tıklanarak kampanyanın durumunun seçildiği alandır.<br>**Yeni:** Henüz aktif olmayan, kayıt girişi durumundaki kampanyalardır. <br>  ❗ _Sadece "Yeni" durumundaki kampanyalarda değişiklik yapılabilir._||
|Promosyon Grubu/Sırası	|**Grup:** Kampanyaları gruplandırmak için ileride anlatılacak olan bir sepete aynı gruptan birden fazla kampanyanın uygulanmaması durumunu sağlamak üzere, aynı grup kampanyaları belirlemek için kullanılır. <br>**Sıra:** Her grubun içerisindeki kampanyaların sepete uygulanma sırasını belirlemek için kullanılır. Müşteri tarafından özellikle bir kampanya seçimi yapılmadıysa sepette girilen sıra ile kampanyalar uygulanmaya çalışılır, seçim yapıldıysa kriterlere uygun olmak koşulu ile seçilen kampanya uygulanır.||
|Kampanya ürünlerde gösterilmesin	|Bu seçenek işaretlenmediğinde kampanyaya giren tüm ürünler için ürün detayında ve listelerinde "Kampanyalı Ürün" ikonu çıkacaktır. Ürün sepete atılmak istendiğinde müşteriye olası tüm kampanyalar gösterilir. Benzer şekilde ürün detayındaki kampanyalar tabında da ürüne ait olarak tüm kampanyalar görülecektir. <br>Eğer seçenek işaretlenirse kampanya ikonu ve kampanya gösterimi fonksiyonu çalışmayacaktır. Bu durumda sistem sepete bu kampanyayı uygulayıp uygulamayacağına en son kendisi karar verecektir.||
|Diğer Diller	|**Ekle** butonuna tıklanarak diğer dil seçenekleri eklenebilir ve  **Sil** butonuna tıklanarak seçilen bir dil silinebilir. Diğer dil seçenekleri sadece Başlık ve Promosyon Metni'ne uygulanır.||


>❗️ _Bu sayfanın en altındaki dil seçenekleri alanıdır._

Kampanya bilgilerini kaydetmek için **KAYDET** butonuna tıklayınız.

Yukarıda doldurmuş olduğunuz formu kaydettikten sonra **Promosyon Kriterleri** ve **Uygulama Bilgileri** kısmı aktif olur. Promosyon kriterlerini oluşturmak için  **Ekle** butonuna tıkladığınızda açılan aşağıdaki formu doldurmanız gerekir.
