...
For this we have activated the <code>Shipment Ent. Code</code> field found in "Shipment Definition" page.  Bunun için Nakliye Tanımı ekranında bulunan  alanı aktif hale getirildi. Bu sayede pazaryeri nakliyesi ile bağlantı kurarak ERP'ye bildirme işlemi sağlanacaktır. 
